...
private:
	...
	void ScanForExemplarPatches() override;

	// IExemplarPatchService

	void ApplyPatches(const cGZPersistResourceKey& key, cISCResExemplar* pExemplar) override;
